...
# ========== GROUPING FACTORS (TABLE 4C1 & BURIED) ==========
GROUPING_FACTORS = {
    ...
    'direct_buried': {1: 1.00, 2: 0.75, 3: 0.65, 4: 0.60, 5: 0.55, 6: 0.50},
    'buried_ducts': {1: 1.00, 2: 0.85, 3: 0.75, 4: 0.70, 5: 0.65, 6: 0.60}
}
...
# ========== DEPTH FACTORS (IEC 60502-2 Table B.12 & B.13) ==========
...
# ========== SOIL RESISTIVITY FACTORS (IEC 60502-2 Table B.14, B.15, B.16) ==========
...
XLPE_90_SINGLE_NON_ARMOURED = {
    1.0: {'ampacity': {'B2': 17.0, 'B34': 15.0, 'C2': 19.0, 'C34': 17.5}, 'voltage_drop': {'dc': 46.0, 'ac': 46.0, 'ac34': 40.0}, 'diameter': 8},
    1.5: {'ampacity': {'B2': 23.0, 'B34': 20.0, 'C2': 25.0, 'C34': 23.0}, 'voltage_drop': {'dc': 31.0, 'ac': 31.0, 'ac34': 27.0}, 'diameter': 9},
    2.5: {'ampacity': {'B2': 31.0, 'B34': 28.0, 'C2': 34.0, 'C34': 31.0}, 'voltage_drop': {'dc': 19.0, 'ac': 19.0, 'ac34': 16.0}, 'diameter': 10},
    4.0: {'ampacity': {'B2': 42.0, 'B34': 37.0, 'C2': 46.0, 'C34': 41.0}, 'voltage_drop': {'dc': 12.0, 'ac': 12.0, 'ac34': 10.0}, 'diameter': 11},
    6.0: {'ampacity': {'B2': 54.0, 'B34': 48.0, 'C2': 59.0, 'C34': 54.0}, 'voltage_drop': {'dc': 7.9, 'ac': 7.9, 'ac34': 6.8}, 'diameter': 12},
    10.0: {'ampacity': {'B2': 75.0, 'B34': 66.0, 'C2': 81.0, 'C34': 74.0}, 'voltage_drop': {'dc': 4.7, 'ac': 4.7, 'ac34': 4.0}, 'diameter': 14},
    16.0: {'ampacity': {'B2': 100.0, 'B34': 88.0, 'C2': 109.0, 'C34': 99.0}, 'voltage_drop': {'dc': 2.9, 'ac': 2.9, 'ac34': 2.5}, 'diameter': 16},
    25.0: {'ampacity': {'B2': 133.0, 'B34': 117.0, 'C2': 143.0, 'C34': 130.0, 'F2_flat': 161.0, 'F34_flat': 141.0, 'F34_trefoil': 135.0, 'G2': 182.0, 'G34': 161.0}, 'R': 1.85, 'X_trefoil': 0.19, 'X_flat_touching': 0.28, 'X_spaced': 0.31, 'diameter': 18},
    35.0: {'ampacity': {'B2': 164.0, 'B34': 144.0, 'C2': 176.0, 'C34': 161.0, 'F2_flat': 200.0, 'F34_flat': 176.0, 'F34_trefoil': 169.0, 'G2': 226.0, 'G34': 201.0}, 'R': 1.35, 'X_trefoil': 0.18, 'X_flat_touching': 0.27, 'X_spaced': 0.29, 'diameter': 20},
    50.0: {'ampacity': {'B2': 198.0, 'B34': 175.0, 'C2': 228.0, 'C34': 209.0, 'F2_flat': 242.0, 'F34_flat': 216.0, 'F34_trefoil': 207.0, 'G2': 275.0, 'G34': 246.0}, 'R': 0.99, 'X_trefoil': 0.18, 'X_flat_touching': 0.27, 'X_spaced': 0.29, 'diameter': 22},
    70.0: {'ampacity': {'B2': 253.0, 'B34': 222.0, 'C2': 293.0, 'C34': 268.0, 'F2_flat': 310.0, 'F34_flat': 279.0, 'F34_trefoil': 268.0, 'G2': 353.0, 'G34': 318.0}, 'R': 0.68, 'X_trefoil': 0.175, 'X_flat_touching': 0.26, 'X_spaced': 0.28, 'diameter': 25},
    95.0: {'ampacity': {'B2': 306.0, 'B34': 269.0, 'C2': 355.0, 'C34': 326.0, 'F2_flat': 377.0, 'F34_flat': 342.0, 'F34_trefoil': 328.0, 'G2': 430.0, 'G34': 389.0}, 'R': 0.49, 'X_trefoil': 0.17, 'X_flat_touching': 0.26, 'X_spaced': 0.27, 'diameter': 28},
    120.0: {'ampacity': {'B2': 354.0, 'B34': 312.0, 'C2': 413.0, 'C34': 379.0, 'F2_flat': 437.0, 'F34_flat': 400.0, 'F34_trefoil': 383.0, 'G2': 500.0, 'G34': 454.0}, 'R': 0.39, 'X_trefoil': 0.165, 'X_flat_touching': 0.25, 'X_spaced': 0.26, 'diameter': 30},
    150.0: {'ampacity': {'B2': 393.0, 'B34': 342.0, 'C2': 476.0, 'C34': 436.0, 'F2_flat': 504.0, 'F34_flat': 464.0, 'F34_trefoil': 444.0, 'G2': 577.0, 'G34': 527.0}, 'R': 0.32, 'X_trefoil': 0.165, 'X_flat_touching': 0.25, 'X_spaced': 0.26, 'diameter': 32},
    185.0: {'ampacity': {'B2': 449.0, 'B34': 384.0, 'C2': 545.0, 'C34': 500.0, 'F2_flat': 575.0, 'F34_flat': 533.0, 'F34_trefoil': 510.0, 'G2': 661.0, 'G34': 605.0}, 'R': 0.25, 'X_trefoil': 0.165, 'X_flat_touching': 0.25, 'X_spaced': 0.26, 'diameter': 35},
    240.0: {'ampacity': {'B2': 528.0, 'B34': 450.0, 'C2': 644.0, 'C34': 590.0, 'F2_flat': 679.0, 'F34_flat': 634.0, 'F34_trefoil': 607.0, 'G2': 781.0, 'G34': 719.0}, 'R': 0.19, 'X_trefoil': 0.16, 'X_flat_touching': 0.25, 'X_spaced': 0.26, 'diameter': 38},
    300.0: {'ampacity': {'B2': 603.0, 'B34': 514.0, 'C2': 743.0, 'C34': 681.0, 'F2_flat': 783.0, 'F34_flat': 736.0, 'F34_trefoil': 703.0, 'G2': 902.0, 'G34': 833.0}, 'R': 0.155, 'X_trefoil': 0.16, 'X_flat_touching': 0.25, 'X_spaced': 0.25, 'diameter': 42},
    400.0: {'ampacity': {'B2': 683.0, 'B34': 684.0, 'C2': 868.0, 'C34': 793.0, 'F2_flat': 940.0, 'F34_flat': 868.0, 'F34_trefoil': 823.0, 'G2': 1058.0, 'G34': 1008.0}, 'R': 0.12, 'X_trefoil': 0.155, 'X_flat_touching': 0.24, 'X_spaced': 0.25, 'diameter': 45},
    500.0: {'ampacity': {'B2': 783.0, 'B34': 666.0, 'C2': 990.0, 'C34': 904.0, 'F2_flat': 1083.0, 'F34_flat': 998.0, 'F34_trefoil': 946.0, 'G2': 1253.0, 'G34': 1169.0}, 'R': 0.093, 'X_trefoil': 0.155, 'X_flat_touching': 0.24, 'X_spaced': 0.25, 'diameter': 48},
    630.0: {'ampacity': {'B2': 900.0, 'B34': 764.0, 'C2': 1130.0, 'C34': 1033.0, 'F2_flat': 1254.0, 'F34_flat': 1151.0, 'F34_trefoil': 1088.0, 'G2': 1454.0, 'G34': 1362.0}, 'R': 0.072, 'X_trefoil': 0.155, 'X_flat_touching': 0.24, 'X_spaced': 0.25, 'diameter': 52},
    800.0: {'ampacity': {'C2': 1288.0, 'C34': 1179.0, 'F2_flat': 1358.0, 'F34_flat': 1275.0, 'F34_trefoil': 1214.0, 'G2': 1581.0, 'G34': 1485.0}, 'R': 0.056, 'X_trefoil': 0.155, 'X_flat_touching': 0.23, 'X_spaced': 0.24, 'diameter': 60},
    1000.0: {'ampacity': {'C2': 1443.0, 'C34': 1323.0, 'F2_flat': 1520.0, 'F34_flat': 1436.0, 'F34_trefoil': 1349.0, 'G2': 1775.0, 'G34': 1671.0}, 'R': 0.045, 'X_trefoil': 0.155, 'X_flat_touching': 0.23, 'X_spaced': 0.24, 'diameter': 68},
}

PVC_70_SINGLE_NON_ARMOURED = {
    1.0: {'ampacity': {'B2': 13.5, 'B34': 12.0, 'C2': 15.5, 'C34': 14.0}, 'voltage_drop': {'dc': 2.8, 'ac': 2.8, 'ac34': 2.4}, 'diameter': 8},
    1.5: {'ampacity': {'B2': 17.5, 'B34': 15.5, 'C2': 20.0, 'C34': 18.0}, 'voltage_drop': None, 'diameter': 9},
    2.5: {'ampacity': {'B2': 24.0, 'B34': 21.0, 'C2': 27.0, 'C34': 25.0}, 'R': 1.75, 'X_trefoil': 0.20, 'X_flat_touching': 0.29, 'X_spaced': 0.33, 'diameter': 10},
    4.0: {'ampacity': {'B2': 32.0, 'B34': 28.0, 'C2': 37.0, 'C34': 33.0}, 'R': 1.25, 'X_trefoil': 0.195, 'X_flat_touching': 0.28, 'X_spaced': 0.31, 'diameter': 11},
    6.0: {'ampacity': {'B2': 41.0, 'B34': 36.0, 'C2': 47.0, 'C34': 43.0}, 'R': 0.93, 'X_trefoil': 0.19, 'X_flat_touching': 0.28, 'X_spaced': 0.30, 'diameter': 12},
    10.0: {'ampacity': {'B2': 57.0, 'B34': 50.0, 'C2': 65.0, 'C34': 59.0}, 'R': 0.63, 'X_trefoil': 0.185, 'X_flat_touching': 0.27, 'X_spaced': 0.29, 'diameter': 14},
    16.0: {'ampacity': {'B2': 76.0, 'B34': 68.0, 'C2': 87.0, 'C34': 79.0}, 'R': 0.46, 'X_trefoil': 0.18, 'X_flat_touching': 0.27, 'X_spaced': 0.28, 'diameter': 16},
    25.0: {'ampacity': {'B2': 101.0, 'B34': 89.0, 'C2': 114.0, 'C34': 104.0, 'F2': 131.0, 'F34_flat': 114.0, 'F34_trefoil': 110.0, 'G2': 146.0, 'G34': 130.0}, 'R': 0.36, 'X_trefoil': 0.175, 'X_flat_touching': 0.26, 'X_spaced': 0.27, 'diameter': 18},
    35.0: {'ampacity': {'B2': 125.0, 'B34': 110.0, 'C2': 141.0, 'C34': 129.0, 'F2': 162.0, 'F34_flat': 143.0, 'F34_trefoil': 137.0, 'G2': 181.0, 'G34': 162.0}, 'R': 0.29, 'X_trefoil': 0.175, 'X_flat_touching': 0.26, 'X_spaced': 0.27, 'diameter': 20},
    50.0: {'ampacity': {'B2': 151.0, 'B34': 134.0, 'C2': 182.0, 'C34': 167.0, 'F2': 178.0, 'F34_flat': 174.0, 'F34_trefoil': 167.0, 'G2': 219.0, 'G34': 197.0}, 'R': 0.23, 'X_trefoil': 0.17, 'X_flat_touching': 0.26, 'X_spaced': 0.27, 'diameter': 22},
    70.0: {'ampacity': {'B2': 192.0, 'B34': 171.0, 'C2': 234.0, 'C34': 214.0, 'F2': 251.0, 'F34_flat': 225.0, 'F34_trefoil': 216.0, 'G2': 281.0, 'G34': 254.0}, 'R': 0.18, 'X_trefoil': 0.165, 'X_flat_touching': 0.25, 'X_spaced': 0.26, 'diameter': 25},
    95.0: {'ampacity': {'B2': 232.0, 'B34': 207.0, 'C2': 284.0, 'C34': 261.0, 'F2': 304.0, 'F34_flat': 275.0, 'F34_trefoil': 264.0, 'G2': 341.0, 'G34': 311.0}, 'R': 0.145, 'X_trefoil': 0.165, 'X_flat_touching': 0.25, 'X_spaced': 0.26, 'diameter': 28},
    120.0: {'ampacity': {'B2': 269.0, 'B34': 239.0, 'C2': 330.0, 'C34': 303.0, 'F2': 352.0, 'F34_flat': 321.0, 'F34_trefoil': 308.0, 'G2': 396.0, 'G34': 362.0}, 'R': 0.105, 'X_trefoil': 0.16, 'X_flat_touching': 0.25, 'X_spaced': 0.26, 'diameter': 30},
    150.0: {'ampacity': {'B2': 300.0, 'B34': 262.0, 'C2': 381.0, 'C34': 349.0, 'F2': 406.0, 'F34_flat': 372.0, 'F34_trefoil': 356.0, 'G2': 456.0, 'G34': 419.0}, 'R': 0.086, 'X_trefoil': 0.155, 'X_flat_touching': 0.24, 'X_spaced': 0.26, 'diameter': 32},
    185.0: {'ampacity': {'B2': 341.0, 'B34': 296.0, 'C2': 436.0, 'C34': 400.0, 'F2': 463.0, 'F34_flat': 427.0, 'F34_trefoil': 409.0, 'G2': 521.0, 'G34': 480.0}, 'R': 0.068, 'X_trefoil': 0.155, 'X_flat_touching': 0.24, 'X_spaced': 0.25, 'diameter': 35},
    240.0: {'ampacity': {'B2': 400.0, 'B34': 346.0, 'C2': 515.0, 'C34': 472.0, 'F2': 546.0, 'F34_flat': 507.0, 'F34_trefoil': 485.0, 'G2': 615.0, 'G34': 567.0}, 'R': 0.053, 'X_trefoil': 0.15, 'X_flat_touching': 0.24, 'X_spaced': 0.25, 'diameter': 38},
    300.0: {'ampacity': {'B2': 458.0, 'B34': 394.0, 'C2': 594.0, 'C34': 545.0, 'F2': 629.0, 'F34_flat': 587.0, 'F34_trefoil': 561.0, 'G2': 709.0, 'G34': 659.0}, 'R': 0.042, 'X_trefoil': 0.15, 'X_flat_touching': 0.24, 'X_spaced': 0.25, 'diameter': 42},
}

PVC_70_MULTI_NON_ARMOURED = {
    1.0: {'ampacity': {'B2': 13.0, 'B34': 11.5, 'C2': 15.0, 'C34': 13.5, 'F2': 17.0, 'F34': 14.5}, 'voltage_drop': 38.0, 'diameter': 10},
    1.5: {'ampacity': {'B2': 16.5, 'B34': 15.0, 'C2': 19.5, 'C34': 17.5, 'F2': 22.0, 'F34': 18.5}, 'voltage_drop': 25.0, 'diameter': 11},
    2.5: {'ampacity': {'B2': 23.0, 'B34': 20.0, 'C2': 27.0, 'C34': 24.0, 'F2': 30.0, 'F34': 25.0}, 'voltage_drop': 15.0, 'diameter': 12},
    4.0: {'ampacity': {'B2': 30.0, 'B34': 27.0, 'C2': 36.0, 'C34': 32.0, 'F2': 40.0, 'F34': 34.0}, 'voltage_drop': 9.5, 'diameter': 14},
    6.0: {'ampacity': {'B2': 38.0, 'B34': 34.0, 'C2': 46.0, 'C34': 41.0, 'F2': 51.0, 'F34': 43.0}, 'voltage_drop': 6.4, 'diameter': 16},
    10.0: {'ampacity': {'B2': 52.0, 'B34': 46.0, 'C2': 63.0, 'C34': 57.0, 'F2': 70.0, 'F34': 60.0}, 'voltage_drop': 3.8, 'diameter': 18},
    16.0: {'ampacity': {'B2': 69.0, 'B34': 62.0, 'C2': 85.0, 'C34': 76.0, 'F2': 94.0, 'F34': 80.0}, 'diameter': 20},
    25.0: {'ampacity': {'B2': 90.0, 'B34': 80.0, 'C2': 112.0, 'C34': 96.0, 'F2': 119.0, 'F34': 101.0}, 'R': 1.5, 'X': 0.145, 'diameter': 22},
    35.0: {'ampacity': {'B2': 111.0, 'B34': 99.0, 'C2': 138.0, 'C34': 119.0, 'F2': 148.0, 'F34': 126.0}, 'R': 1.1, 'X': 0.145, 'diameter': 25},
    50.0: {'ampacity': {'B2': 133.0, 'B34': 118.0, 'C2': 168.0, 'C34': 144.0, 'F2': 180.0, 'F34': 153.0}, 'R': 0.8, 'X': 0.14, 'diameter': 28},
    70.0: {'ampacity': {'B2': 168.0, 'B34': 149.0, 'C2': 213.0, 'C34': 184.0, 'F2': 232.0, 'F34': 196.0}, 'R': 0.55, 'X': 0.14, 'diameter': 32},
    95.0: {'ampacity': {'B2': 201.0, 'B34': 179.0, 'C2': 258.0, 'C34': 223.0, 'F2': 282.0, 'F34': 238.0}, 'R': 0.41, 'X': 0.135, 'diameter': 35},
    120.0: {'ampacity': {'B2': 232.0, 'B34': 206.0, 'C2': 299.0, 'C34': 259.0, 'F2': 328.0, 'F34': 276.0}, 'R': 0.33, 'X': 0.135, 'diameter': 38},
    150.0: {'ampacity': {'B2': 258.0, 'B34': 225.0, 'C2': 344.0, 'C34': 299.0, 'F2': 379.0, 'F34': 319.0}, 'R': 0.26, 'X': 0.13, 'diameter': 42},
    185.0: {'ampacity': {'B2': 294.0, 'B34': 255.0, 'C2': 392.0, 'C34': 341.0, 'F2': 434.0, 'F34': 364.0}, 'R': 0.21, 'X': 0.13, 'diameter': 45},
    240.0: {'ampacity': {'B2': 344.0, 'B34': 297.0, 'C2': 461.0, 'C34': 403.0, 'F2': 514.0, 'F34': 430.0}, 'R': 0.165, 'X': 0.13, 'diameter': 50},
    300.0: {'ampacity': {'B2': 394.0, 'B34': 339.0, 'C2': 530.0, 'C34': 464.0, 'F2': 593.0, 'F34': 497.0}, 'R': 0.135, 'X': 0.13, 'diameter': 55},
    400.0: {'ampacity': {'B2': 470.0, 'B34': 402.0, 'C2': 634.0, 'C34': 557.0, 'F2': 715.0, 'F34': 597.0}, 'R': 0.1, 'X': 0.125, 'diameter': 60},
}

PVC_70_SINGLE_ARMOURED = {
    50.0: {'ampacity': {'C2': 193.0, 'C34': 179.0, 'F2_touch': 205.0, 'F34_touch_flat': 189.0, 'F34_touch_trefoil': 181.0}, 'R': 0.93, 'X_trefoil': 0.19, 'X_flat_touching': 0.26, 'X_spaced': 0.30, 'diameter': 25},
    70.0: {'ampacity': {'C2': 245.0, 'C34': 225.0, 'F2_touch': 259.0, 'F34_touch_flat': 238.0, 'F34_touch_trefoil': 231.0}, 'R': 0.63, 'X_trefoil': 0.18, 'X_flat_touching': 0.25, 'X_spaced': 0.29, 'diameter': 28},
    95.0: {'ampacity': {'C2': 296.0, 'C34': 269.0, 'F2_touch': 313.0, 'F34_touch_flat': 285.0, 'F34_touch_trefoil': 280.0}, 'R': 0.46, 'X_trefoil': 0.175, 'X_flat_touching': 0.25, 'X_spaced': 0.28, 'diameter': 32},
    120.0: {'ampacity': {'C2': 342.0, 'C34': 309.0, 'F2_touch': 360.0, 'F34_touch_flat': 327.0, 'F34_touch_trefoil': 324.0}, 'R': 0.36, 'X_trefoil': 0.17, 'X_flat_touching': 0.24, 'X_spaced': 0.28, 'diameter': 35},
    150.0: {'ampacity': {'C2': 393.0, 'C34': 352.0, 'F2_touch': 413.0, 'F34_touch_flat': 373.0, 'F34_touch_trefoil': 373.0}, 'R': 0.29, 'X_trefoil': 0.165, 'X_flat_touching': 0.24, 'X_spaced': 0.27, 'diameter': 38},
    185.0: {'ampacity': {'C2': 447.0, 'C34': 399.0, 'F2_touch': 469.0, 'F34_touch_flat': 422.0, 'F34_touch_trefoil': 425.0}, 'R': 0.23, 'X_trefoil': 0.16, 'X_flat_touching': 0.23, 'X_spaced': 0.27, 'diameter': 42},
    240.0: {'ampacity': {'C2': 525.0, 'C34': 465.0, 'F2_touch': 550.0, 'F34_touch_flat': 492.0, 'F34_touch_trefoil': 501.0}, 'R': 0.18, 'X_trefoil': 0.16, 'X_flat_touching': 0.23, 'X_spaced': 0.26, 'diameter': 48},
    300.0: {'ampacity': {'C2': 594.0, 'C34': 515.0, 'F2_touch': 624.0, 'F34_touch_flat': 547.0, 'F34_touch_trefoil': 567.0}, 'R': 0.145, 'X_trefoil': 0.155, 'X_flat_touching': 0.22, 'X_spaced': 0.26, 'diameter': 52},
    400.0: {'ampacity': {'C2': 687.0, 'C34': 575.0, 'F2_touch': 723.0, 'F34_touch_flat': 618.0, 'F34_touch_trefoil': 657.0}, 'R': 0.105, 'X_trefoil': 0.13, 'X_flat_touching': 0.21, 'X_spaced': 0.24, 'diameter': 58},
    500.0: {'ampacity': {'C2': 763.0, 'C34': 622.0, 'F2_touch': 805.0, 'F34_touch_flat': 673.0, 'F34_touch_trefoil': 731.0}, 'R': 0.086, 'X_trefoil': 0.145, 'X_flat_touching': 0.20, 'X_spaced': 0.23, 'diameter': 65},
    630.0: {'ampacity': {'C2': 843.0, 'C34': 669.0, 'F2_touch': 891.0, 'F34_touch_flat': 728.0, 'F34_touch_trefoil': 809.0}, 'R': 0.068, 'X_trefoil': 0.145, 'X_flat_touching': 0.195, 'X_spaced': 0.22, 'diameter': 72},
    800.0: {'ampacity': {'C2': 919.0, 'C34': 710.0, 'F2_touch': 976.0, 'F34_touch_flat': 777.0, 'F34_touch_trefoil': 886.0}, 'R': 0.053, 'X_trefoil': 0.14, 'X_flat_touching': 0.18, 'X_spaced': 0.21, 'diameter': 80},
    1000.0: {'ampacity': {'C2': 975.0, 'C34': 737.0, 'F2_touch': 1041.0, 'F34_touch_flat': 808.0, 'F34_touch_trefoil': 945.0}, 'R': 0.042, 'X_trefoil': 0.135, 'X_flat_touching': 0.17, 'X_spaced': 0.19, 'diameter': 88},
}

PVC_70_MULTI_ARMOURED = {
    1.5: {'ampacity': {'C2': 21.0, 'C34': 18.0, 'E2': 22.0, 'E34': 19.0, 'D2': 22.0, 'D34': 18.0}, 'voltage_drop': {'dc': 29.0, 'ac': 29.0, 'ac34': 25.0}, 'diameter': 12},
    2.5: {'ampacity': {'C2': 28.0, 'C34': 25.0, 'E2': 31.0, 'E34': 26.0, 'D2': 29.0, 'D34': 24.0}, 'voltage_drop': {'dc': 18.0, 'ac': 18.0, 'ac34': 15.0}, 'diameter': 14},
    4.0: {'ampacity': {'C2': 38.0, 'C34': 33.0, 'E2': 41.0, 'E34': 35.0, 'D2': 37.0, 'D34': 30.0}, 'voltage_drop': {'dc': 11.0, 'ac': 11.0, 'ac34': 9.5}, 'diameter': 16},
    6.0: {'ampacity': {'C2': 49.0, 'C34': 42.0, 'E2': 53.0, 'E34': 45.0, 'D2': 46.0, 'D34': 38.0}, 'voltage_drop': {'dc': 7.3, 'ac': 7.3, 'ac34': 6.4}, 'diameter': 18},
    10.0: {'ampacity': {'C2': 67.0, 'C34': 58.0, 'E2': 72.0, 'E34': 62.0, 'D2': 60.0, 'D34': 50.0}, 'voltage_drop': {'dc': 4.4, 'ac': 4.4, 'ac34': 3.8}, 'diameter': 20},
    16.0: {'ampacity': {'C2': 89.0, 'C34': 77.0, 'E2': 97.0, 'E34': 83.0, 'D2': 78.0, 'D34': 64.0}, 'voltage_drop': {'dc': 2.8, 'ac': 2.8, 'ac34': 2.4}, 'diameter': 22},
    25.0: {'ampacity': {'C2': 118.0, 'C34': 102.0, 'E2': 128.0, 'E34': 110.0, 'D2': 99.0, 'D34': 82.0}, 'R': 1.75, 'X': 0.17, 'diameter': 25},
    35.0: {'ampacity': {'C2': 145.0, 'C34': 125.0, 'E2': 157.0, 'E34': 135.0, 'D2': 119.0, 'D34': 98.0}, 'R': 1.25, 'X': 0.165, 'diameter': 28},
    50.0: {'ampacity': {'C2': 175.0, 'C34': 151.0, 'E2': 190.0, 'E34': 163.0, 'D2': 140.0, 'D34': 116.0}, 'R': 0.93, 'X': 0.165, 'diameter': 32},
    70.0: {'ampacity': {'C2': 222.0, 'C34': 192.0, 'E2': 241.0, 'E34': 207.0, 'D2': 173.0, 'D34': 143.0}, 'R': 0.63, 'X': 0.16, 'diameter': 36},
    95.0: {'ampacity': {'C2': 269.0, 'C34': 231.0, 'E2': 291.0, 'E34': 251.0, 'D2': 204.0, 'D34': 169.0}, 'R': 0.46, 'X': 0.155, 'diameter': 40},
    120.0: {'ampacity': {'C2': 310.0, 'C34': 267.0, 'E2': 336.0, 'E34': 290.0, 'D2': 231.0, 'D34': 192.0}, 'R': 0.36, 'X': 0.155, 'diameter': 44},
    150.0: {'ampacity': {'C2': 356.0, 'C34': 306.0, 'E2': 386.0, 'E34': 332.0, 'D2': 261.0, 'D34': 217.0}, 'R': 0.29, 'X': 0.155, 'diameter': 48},
    185.0: {'ampacity': {'C2': 405.0, 'C34': 348.0, 'E2': 439.0, 'E34': 378.0, 'D2': 292.0, 'D34': 243.0}, 'R': 0.23, 'X': 0.15, 'diameter': 52},
    240.0: {'ampacity': {'C2': 476.0, 'C34': 409.0, 'E2': 516.0, 'E34': 445.0, 'D2': 336.0, 'D34': 280.0}, 'R': 0.18, 'X': 0.15, 'diameter': 58},
    300.0: {'ampacity': {'C2': 547.0, 'C34': 469.0, 'E2': 592.0, 'E34': 510.0, 'D2': 379.0, 'D34': 316.0}, 'R': 0.145, 'X': 0.145, 'diameter': 65},
    400.0: {'ampacity': {'C2': 621.0, 'C34': 540.0, 'E2': 683.0, 'E34': 590.0}, 'R': 0.105, 'X': 0.145, 'diameter': 72},
}

XLPE_90_MULTI_NON_ARMOURED = {
    1.0: {'ampacity': {'B2': 17.0, 'B34': 15.0, 'C2': 19.0, 'C34': 17.0, 'E2': 21.0, 'E34': 18.0}, 'voltage_drop': {'dc': 46.0, 'ac': 46.0, 'ac34': 40.0}, 'diameter': 10},
    1.5: {'ampacity': {'B2': 22.0, 'B34': 19.5, 'C2': 24.0, 'C34': 22.0, 'E2': 26.0, 'E34': 23.0}, 'voltage_drop': {'dc': 31.0, 'ac': 31.0, 'ac34': 27.0}, 'diameter': 11},
    2.5: {'ampacity': {'B2': 30.0, 'B34': 26.0, 'C2': 33.0, 'C34': 30.0, 'E2': 36.0, 'E34': 32.0}, 'voltage_drop': {'dc': 19.0, 'ac': 19.0, 'ac34': 16.0}, 'diameter': 12},
    4.0: {'ampacity': {'B2': 40.0, 'B34': 35.0, 'C2': 45.0, 'C34': 40.0, 'E2': 49.0, 'E34': 42.0}, 'voltage_drop': {'dc': 12.0, 'ac': 12.0, 'ac34': 10.0}, 'diameter': 14},
    6.0: {'ampacity': {'B2': 51.0, 'B34': 44.0, 'C2': 58.0, 'C34': 52.0, 'E2': 63.0, 'E34': 54.0}, 'voltage_drop': {'dc': 7.9, 'ac': 7.9, 'ac34': 6.8}, 'diameter': 16},
    10.0: {'ampacity': {'B2': 69.0, 'B34': 60.0, 'C2': 80.0, 'C34': 71.0, 'E2': 86.0, 'E34': 75.0}, 'voltage_drop': {'dc': 4.7, 'ac': 4.7, 'ac34': 4.0}, 'diameter': 18},
    16.0: {'ampacity': {'B2': 91.0, 'B34': 80.0, 'C2': 107.0, 'C34': 96.0, 'E2': 115.0, 'E34': 100.0}, 'voltage_drop': {'dc': 2.9, 'ac': 2.9, 'ac34': 2.5}, 'diameter': 20},
    25.0: {'ampacity': {'B2': 119.0, 'B34': 105.0, 'C2': 138.0, 'C34': 119.0, 'E2': 149.0, 'E34': 127.0}, 'R': 1.85, 'X': 0.16, 'diameter': 22},
    35.0: {'ampacity': {'B2': 146.0, 'B34': 128.0, 'C2': 171.0, 'C34': 147.0, 'E2': 185.0, 'E34': 158.0}, 'R': 1.35, 'X': 0.155, 'diameter': 25},
    50.0: {'ampacity': {'B2': 175.0, 'B34': 154.0, 'C2': 209.0, 'C34': 179.0, 'E2': 225.0, 'E34': 192.0}, 'R': 0.98, 'X': 0.155, 'diameter': 28},
    70.0: {'ampacity': {'B2': 221.0, 'B34': 194.0, 'C2': 269.0, 'C34': 229.0, 'E2': 289.0, 'E34': 246.0}, 'R': 0.67, 'X': 0.15, 'diameter': 32},
    95.0: {'ampacity': {'B2': 265.0, 'B34': 233.0, 'C2': 328.0, 'C34': 278.0, 'E2': 352.0, 'E34': 298.0}, 'R': 0.49, 'X': 0.15, 'diameter': 35},
    120.0: {'ampacity': {'B2': 305.0, 'B34': 268.0, 'C2': 382.0, 'C34': 322.0, 'E2': 410.0, 'E34': 346.0}, 'R': 0.39, 'X': 0.145, 'diameter': 38},
    150.0: {'ampacity': {'B2': 334.0, 'B34': 300.0, 'C2': 441.0, 'C34': 371.0, 'E2': 473.0, 'E34': 399.0}, 'R': 0.31, 'X': 0.145, 'diameter': 42},
    185.0: {'ampacity': {'B2': 384.0, 'B34': 340.0, 'C2': 506.0, 'C34': 424.0, 'E2': 542.0, 'E34': 456.0}, 'R': 0.25, 'X': 0.145, 'diameter': 45},
    240.0: {'ampacity': {'B2': 459.0, 'B34': 398.0, 'C2': 599.0, 'C34': 500.0, 'E2': 641.0, 'E34': 538.0}, 'R': 0.195, 'X': 0.14, 'diameter': 50},
    300.0: {'ampacity': {'B2': 532.0, 'B34': 455.0, 'C2': 693.0, 'C34': 576.0, 'E2': 741.0, 'E34': 621.0}, 'R': 0.155, 'X': 0.14, 'diameter': 55},
    400.0: {'ampacity': {'B2': 625.0, 'B34': 536.0, 'C2': 803.0, 'C34': 667.0, 'E2': 865.0, 'E34': 741.0}, 'R': 0.12, 'X': 0.14, 'diameter': 60},
}

XLPE_90_SINGLE_ARMOURED = {
    50.0: {'ampacity': {'C2': 237.0, 'C34': 220.0, 'F2_touch': 253.0, 'F34_touch_flat': 232.0, 'F34_touch_trefoil': 222.0}, 'R': 0.98, 'X_trefoil': 0.18, 'X_flat_touching': 0.25, 'X_spaced': 0.29, 'diameter': 25},
    70.0: {'ampacity': {'C2': 303.0, 'C34': 277.0, 'F2_touch': 322.0, 'F34_touch_flat': 293.0, 'F34_touch_trefoil': 285.0}, 'R': 0.67, 'X_trefoil': 0.17, 'X_flat_touching': 0.25, 'X_spaced': 0.29, 'diameter': 28},
    95.0: {'ampacity': {'C2': 367.0, 'C34': 333.0, 'F2_touch': 389.0, 'F34_touch_flat': 352.0, 'F34_touch_trefoil': 346.0}, 'R': 0.49, 'X_trefoil': 0.17, 'X_flat_touching': 0.24, 'X_spaced': 0.28, 'diameter': 32},
    120.0: {'ampacity': {'C2': 425.0, 'C34': 383.0, 'F2_touch': 449.0, 'F34_touch_flat': 405.0, 'F34_touch_trefoil': 402.0}, 'R': 0.39, 'X_trefoil': 0.165, 'X_flat_touching': 0.24, 'X_spaced': 0.27, 'diameter': 35},
    150.0: {'ampacity': {'C2': 488.0, 'C34': 437.0, 'F2_touch': 516.0, 'F34_touch_flat': 462.0, 'F34_touch_trefoil': 463.0}, 'R': 0.31, 'X_trefoil': 0.16, 'X_flat_touching': 0.23, 'X_spaced': 0.27, 'diameter': 38},
    185.0: {'ampacity': {'C2': 557.0, 'C34': 496.0, 'F2_touch': 587.0, 'F34_touch_flat': 524.0, 'F34_touch_trefoil': 529.0}, 'R': 0.25, 'X_trefoil': 0.16, 'X_flat_touching': 0.23, 'X_spaced': 0.26, 'diameter': 42},
    240.0: {'ampacity': {'C2': 656.0, 'C34': 579.0, 'F2_touch': 689.0, 'F34_touch_flat': 612.0, 'F34_touch_trefoil': 625.0}, 'R': 0.195, 'X_trefoil': 0.155, 'X_flat_touching': 0.22, 'X_spaced': 0.26, 'diameter': 48},
    300.0: {'ampacity': {'C2': 755.0, 'C34': 662.0, 'F2_touch': 792.0, 'F34_touch_flat': 700.0, 'F34_touch_trefoil': 720.0}, 'R': 0.155, 'X_trefoil': 0.15, 'X_flat_touching': 0.22, 'X_spaced': 0.25, 'diameter': 52},
    400.0: {'ampacity': {'C2': 853.0, 'C34': 717.0, 'F2_touch': 899.0, 'F34_touch_flat': 767.0, 'F34_touch_trefoil': 815.0}, 'R': 0.115, 'X_trefoil': 0.15, 'X_flat_touching': 0.21, 'X_spaced': 0.24, 'diameter': 58},
    500.0: {'ampacity': {'C2': 962.0, 'C34': 791.0, 'F2_touch': 1016.0, 'F34_touch_flat': 851.0, 'F34_touch_trefoil': 918.0}, 'R': 0.093, 'X_trefoil': 0.145, 'X_flat_touching': 0.20, 'X_spaced': 0.24, 'diameter': 65},
    630.0: {'ampacity': {'C2': 1082.0, 'C34': 861.0, 'F2_touch': 1146.0, 'F34_touch_flat': 935.0, 'F34_touch_trefoil': 1027.0}, 'R': 0.073, 'X_trefoil': 0.145, 'X_flat_touching': 0.195, 'X_spaced': 0.23, 'diameter': 72},
    800.0: {'ampacity': {'C2': 1170.0, 'C34': 904.0, 'F2_touch': 1246.0, 'F34_touch_flat': 987.0, 'F34_touch_trefoil': 1119.0}, 'R': 0.056, 'X_trefoil': 0.14, 'X_flat_touching': 0.18, 'X_spaced': 0.23, 'diameter': 80},
    1000.0: {'ampacity': {'C2': 1261.0, 'C34': 961.0, 'F2_touch': 1345.0, 'F34_touch_flat': 1055.0, 'F34_touch_trefoil': 1214.0}, 'R': 0.045, 'X_trefoil': 0.135, 'X_flat_touching': 0.17, 'X_spaced': 0.21, 'diameter': 88},
}

XLPE_90_MULTI_ARMOURED = {
    1.5: {'ampacity': {'C2': 27.0, 'C34': 23.0, 'E2': 29.0, 'E34': 25.0, 'D2': 25.0, 'D34': 21.0}, 'voltage_drop': {'dc': 31.0, 'ac': 31.0, 'ac34': 27.0}, 'diameter': 12},
    2.5: {'ampacity': {'C2': 36.0, 'C34': 31.0, 'E2': 39.0, 'E34': 33.0, 'D2': 33.0, 'D34': 28.0}, 'voltage_drop': {'dc': 19.0, 'ac': 19.0, 'ac34': 16.0}, 'diameter': 14},
    4.0: {'ampacity': {'C2': 49.0, 'C34': 42.0, 'E2': 52.0, 'E34': 44.0, 'D2': 43.0, 'D34': 36.0}, 'voltage_drop': {'dc': 12.0, 'ac': 12.0, 'ac34': 10.0}, 'diameter': 16},
    6.0: {'ampacity': {'C2': 62.0, 'C34': 53.0, 'E2': 66.0, 'E34': 56.0, 'D2': 53.0, 'D34': 44.0}, 'voltage_drop': {'dc': 7.9, 'ac': 7.9, 'ac34': 6.8}, 'diameter': 18},
    10.0: {'ampacity': {'C2': 85.0, 'C34': 73.0, 'E2': 90.0, 'E34': 78.0, 'D2': 71.0, 'D34': 58.0}, 'voltage_drop': {'dc': 4.7, 'ac': 4.7, 'ac34': 4.0}, 'diameter': 20},
    16.0: {'ampacity': {'C2': 110.0, 'C34': 94.0, 'E2': 115.0, 'E34': 99.0, 'D2': 91.0, 'D34': 75.0}, 'voltage_drop': {'dc': 2.9, 'ac': 2.9, 'ac34': 2.5}, 'diameter': 22},
    25.0: {'ampacity': {'C2': 146.0, 'C34': 124.0, 'E2': 152.0, 'E34': 131.0, 'D2': 116.0, 'D34': 96.0}, 'R': 1.85, 'X': 0.16, 'diameter': 25},
    35.0: {'ampacity': {'C2': 180.0, 'C34': 154.0, 'E2': 188.0, 'E34': 162.0, 'D2': 139.0, 'D34': 115.0}, 'R': 1.35, 'X': 0.155, 'diameter': 28},
    50.0: {'ampacity': {'C2': 219.0, 'C34': 187.0, 'E2': 228.0, 'E34': 197.0, 'D2': 164.0, 'D34': 135.0}, 'R': 0.98, 'X': 0.155, 'diameter': 32},
    70.0: {'ampacity': {'C2': 279.0, 'C34': 238.0, 'E2': 291.0, 'E34': 251.0, 'D2': 203.0, 'D34': 167.0}, 'R': 0.67, 'X': 0.15, 'diameter': 36},
    95.0: {'ampacity': {'C2': 338.0, 'C34': 289.0, 'E2': 354.0, 'E34': 304.0, 'D2': 239.0, 'D34': 197.0}, 'R': 0.49, 'X': 0.15, 'diameter': 40},
    120.0: {'ampacity': {'C2': 392.0, 'C34': 335.0, 'E2': 410.0, 'E34': 353.0, 'D2': 271.0, 'D34': 223.0}, 'R': 0.39, 'X': 0.145, 'diameter': 44},
    150.0: {'ampacity': {'C2': 451.0, 'C34': 386.0, 'E2': 472.0, 'E34': 406.0, 'D2': 306.0, 'D34': 251.0}, 'R': 0.31, 'X': 0.145, 'diameter': 48},
    185.0: {'ampacity': {'C2': 515.0, 'C34': 441.0, 'E2': 539.0, 'E34': 463.0, 'D2': 343.0, 'D34': 281.0}, 'R': 0.25, 'X': 0.145, 'diameter': 52},
    240.0: {'ampacity': {'C2': 607.0, 'C34': 520.0, 'E2': 636.0, 'E34': 546.0, 'D2': 395.0, 'D34': 324.0}, 'R': 0.195, 'X': 0.14, 'diameter': 58},
    300.0: {'ampacity': {'C2': 698.0, 'C34': 599.0, 'E2': 732.0, 'E34': 628.0, 'D2': 446.0, 'D34': 365.0}, 'R': 0.155, 'X': 0.14, 'diameter': 65},
    400.0: {'ampacity': {'C2': 787.0, 'C34': 673.0, 'E2': 847.0, 'E34': 728.0}, 'R': 0.12, 'X': 0.14, 'diameter': 72},
}
...
def select_cable_automatically(load, cable_db, cable_calc, ambient_temp,
    ...
    for size in available_sizes:
        ...
        elif installation_method == 'D' or installation_method == 'D_direct':
            if load_phase == '3-phase':
...
class CableWordReport:
    ...
    def add_detailed_calculations(self, detailed_calcs):
        ...
        for i, calc in enumerate(detailed_calcs):
            ...
            self.doc.add_paragraph('k2 (Grouping correction): Based on IEC 60364-5-52 Table 4C1')
            ...
            # Step 4: Cable selection (automatic)
    ...
    def add_cb_results(self, cb_results, main_cbs_by_voltage, pole_selections, main_pole_selections, cb_details=None, selected_manufacturer='Schneider Electric'):
        ...
        # ========== DETAILED CALCULATIONS FOR EACH LOAD ==========
        if cb_details:
        ...
        if main_cbs_by_voltage:
            for voltage, main_cb in main_cbs_by_voltage.items():
                ...
                # Detailed calculation for main CB
...
if st.session_state.selected_calculator == "📋 LOAD SHEET":
    ...
    with lp_tabs[0]:
        ...
        structure_type = st.selectbox("Select structure type", ["Substation Building", "Central Control Building", "Column 4-C01"])
        ...
        if st.session_state.loads_df.empty:
            ...
            edited_df = st.data_editor(
                ...
                column_config={
                    ...
                    "Installation Method": st.column_config.SelectboxColumn("Installation method", options=['B', 'C', 'D', 'D_direct', 'E', 'F', 'G']),
                    "Cables in Group": st.column_config.NumberColumn("Cables in group", min_value=1, max_value=20, step=1),
                    "Cable Arrangement": st.column_config.SelectboxColumn("Cable arrangement", options=['bunched_in_air_surface_enclosed', 'single_layer_wall_floor', 'single_layer_perforated_tray', 'single_layer_ladder_cleats', 'direct_buried', 'buried_ducts'], format_func=format_cable_arrangement),
                    ...
                    "Soil Resistivity (K.m/W)": st.column_config.NumberColumn("Soil resistivity", min_value=0.5, max_value=3.0, step=0.1, help="Only for buried installations (Method D or D_direct) - Reference 1.5 K.m/W"),
                    "Burial Depth (m)": st.column_config.NumberColumn("Burial depth (m)", min_value=0.3, max_value=3.0, step=0.1, help="Only for buried installations (Method D or D_direct) - Reference 0.8m")
                }
            )
...
**k2 (Grouping correction)** - Based on IEC 60364-5-52 Table 4C1 (for air) or spacing factors (for buried)
